...
printf "\n"
options=("Yes - Deploy Amazon Opensearch Serverless for RAG" "No - I will only test Amazon Bedrock without RAG" "Quit")
aoss_selected='yes'
...
then
    ...
    CHAT_COLLECTION_ENDPOINT=https://dummy-chat-endpoint.amazonaws.com
