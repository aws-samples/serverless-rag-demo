...
then
    ...
    cdk deploy -c environment_name=$1 -c collection_endpoint=$COLLECTION_ENDPOINT -c current_timestamp=$CURRENT_UTC_TIMESTAMP llm_model_id=$model_id ApiGwLlmsLambda"$1"Stack --require-approval never
